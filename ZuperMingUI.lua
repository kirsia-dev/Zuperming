...
function ZuperMing:CreateWindow(Config)
  ...
  local CurrentSizeX = math.clamp(Config[4] and Config[4].X.Offset or (Config.SizeUi and Config.SizeUi.X.Offset or 550), MinSizeX, MaxSizeX)
  local CurrentSizeY = math.clamp(Config[4] and Config[4].Y.Offset or (Config.SizeUi and Config.SizeUi.Y.Offset or 315), MinSizeY, MaxSizeY)
