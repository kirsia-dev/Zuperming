...
local FolderName = "Zuperming | Farm"
        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    Library:SetNotification({Title = "ZuperMing", Description = "| ZuperMing", Content = "Lỗi: Không tìm thấy toạ độ cho Melee này ở Sea hiện tại!", Time = 0.5, Delay = 3})
                ...
                if lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if dist > 15 then
                        ...
                        Library:SetNotification({Title = "ZuperMing", Description = "| ZuperMing", Content = "Đã mua: ", Time = 0.5, Delay = 2})
                        task.wait(1)
                    end
                end
            end
...
local _s_FarmSettings_3 = Tabs.FarmSettings:AddSection("Server Functions", true)

_s_FarmSettings_3:AddButton({
...
local _s_FarmSettings_4 = Tabs.FarmSettings:AddSection("Player GUI / Others", true)

_s_FarmSettings_4:AddButton({
...
local _s_FarmSettings_5 = Tabs.FarmSettings:AddSection("Graphics / Haki Stats", true)

local HakiStages = {"Stage 0", "Stage 1", "Stage 2", "Stage 3", "Stage 4", "Stage 5"}
_s_FarmSettings_5:AddDropdown({
...
local _s_FarmSettings_6 = Tabs.FarmSettings:AddSection("Misc Graphics", true)

_s_FarmSettings_6:AddToggle({
...
local _s_FarmSettings_7 = Tabs.FarmSettings:AddSection("Configure - God", true)

_s_FarmSettings_7:AddButton({
