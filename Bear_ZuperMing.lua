...
local Tabs = {
    InfoGroup      = MainWindow:CreateTab({ Name = "Info/Group", Icon = "info" }),
    StatusServer   = MainWindow:CreateTab({ Name = "Status/Server", Icon = "activity" }),
    Farming        = MainWindow:CreateTab({ Name = "Farming", Icon = "swords" }),
    QuestsOther    = MainWindow:CreateTab({ Name = "Quests/Other", Icon = "list-checks" }),
    FarmSettings   = MainWindow:CreateTab({ Name = "Farm Settings", Icon = "settings-2" }),
    AutoFishing    = MainWindow:CreateTab({ Name = "Auto Fishing", Icon = "fish" }),
    SeaEvent       = MainWindow:CreateTab({ Name = "Sea Event", Icon = "waves" }),
    VolcanoDojo    = MainWindow:CreateTab({ Name = "Volcano/Dojo", Icon = "flame" }),
    MirageRace     = MainWindow:CreateTab({ Name = "Mirage/Race", Icon = "zap" }),
    FruitsCheck    = MainWindow:CreateTab({ Name = "Fruits/Check", Icon = "cherry" }),
    RaidDungoen    = MainWindow:CreateTab({ Name = "Raid/Dungoen", Icon = "shield" }),
    TeleportWorld  = MainWindow:CreateTab({ Name = "Teleport/World", Icon = "map-pin" }),
    PvPPlayer      = MainWindow:CreateTab({ Name = "PvP/Player", Icon = "crosshair" }),
    EspStats       = MainWindow:CreateTab({ Name = "Esp/Stats", Icon = "eye" }),
    Shop           = MainWindow:CreateTab({ Name = "Shop", Icon = "shopping-cart" }),
...
local _s_StatusServer_1 = Tabs.StatusServer:AddSection("", true)
local Timmessss = _s_StatusServer_1:AddParagraph({
    Title = "Time",
    Content = ""
})
function UpdateTime()
...
local Miragecheck = _s_StatusServer_1:AddParagraph({
    Title = "Mirage Island",
    Content = "Status: "
})
spawn(function()
...
local Kitsunecheck = _s_StatusServer_1:AddParagraph({
...
local CPrehistoriccheck = _s_StatusServer_1:AddParagraph({
...
local FrozenIsland = _s_StatusServer_1:AddParagraph({
...
local MobCakePrince = _s_StatusServer_1:AddParagraph({
...
local TyrantStatus = _s_StatusServer_1:AddParagraph({
...
local CheckRip = _s_StatusServer_1:AddParagraph({
    Title = "Rip_Indra",
    Content = "Status: "
})
spawn(function()
...
local CheckDoughKing = _s_StatusServer_1:AddParagraph({
    Title = "Dough King",
    Content = "Status: "
})
spawn(function()
...
local EliteHunter = _s_StatusServer_1:AddParagraph({
    Title = "Elite Hunter",
    Content = "Status: "
})
spawn(function()
...
local Pullever = _s_StatusServer_1:AddParagraph({
    Title = "Pull Lever",
    Content = "Status: "
})
spawn(function()
...
local FM = _s_StatusServer_1:AddParagraph({
    Title = "Full Moon",
    Content = ""
})
spawn(function()
...
local LegendarySword = _s_StatusServer_1:AddParagraph({
...
local Bone = _s_StatusServer_1:AddParagraph({
    Title = "Bone",
    Content = ""
})
spawn(function()
...
local _s_FarmSettings_1 = Tabs.FarmSettings:AddSection("", true)
_s_FarmSettings_1:AddDropdown({
...
local targetDisplay = _s_FarmSettings_1:AddParagraph({
...
_s_Farming_7:AddToggle({ Title = "Use Skill Z (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.Z = v end })
_s_Farming_7:AddToggle({ Title = "Use Skill X (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.X = v end })
_s_Farming_7:AddToggle({ Title = "Use Skill C (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.C = v end })
_s_Farming_7:AddToggle({ Title = "Use Skill V (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.V = v end })
_s_Farming_7:AddToggle({ Title = "Use Skill F (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.F = v end })
...
local _s_FarmSettings_2 = Tabs.FarmSettings:AddSection("Auto Hop", true)

_s_FarmSettings_2:AddToggle({
...
local _s_AutoFishing_1 = Tabs.AutoFishing:AddSection("Fishing", true)
            ...
            pcall(function()
                ...
                if _G.SelectedRod and (not equippedTool or equippedTool.Name ~= _G.SelectedRod) then
                    ...
                    if rodInBag then
                        ...
                        Library:SetNotification({Title = "Auto Fish", Description = "| Auto Fish", Content = "please equip: ", Time = 0.5, Delay = 3})
                        return
                    end
                end
                ...
                if equippedTool then
                    ...
                    elseif serverState == "Biting" then
                        ...
                        Library:SetNotification({Title = "Auto Fish", Description = "| Auto Fish", Content = "New item caught", Time = 0.5, Delay = 3})
                    end
                end
            end)
        end
...
if World1 then
local _s_QuestsOther_1 = Tabs.QuestsOther:AddSection("Travel To Sea 2", true)

    local TravelDresToggle = _s_QuestsOther_1:AddToggle({
...
if World2 then
local _s_QuestsOther_2 = Tabs.QuestsOther:AddSection("Travel To Sea 3", true)

    local AutoZouToggle = _s_QuestsOther_2:AddToggle({
...
local _s_QuestsOther_3 = Tabs.QuestsOther:AddSection("Quests", true)

_s_QuestsOther_3:AddToggle({
...
local _s_QuestsOther_4 = Tabs.QuestsOther:AddSection("Cursed Swords", true)

    local EliteProgressPara = _s_QuestsOther_4:AddParagraph({ Title = "Elites Process ", Content = "" });
    spawn(function()
        while wait(Sec) do
            pcall(function()
            end);
...
local _s_QuestsOther_5 = Tabs.QuestsOther:AddSection("Buso/Aura Colours", true)

    _s_QuestsOther_5:AddToggle({
...
local _s_QuestsOther_6 = Tabs.QuestsOther:AddSection("Item", true)
if World2 then

    _s_QuestsOther_6:AddToggle({
...
if World3 then
    ...
    local SoulGuitarStatus = _s_QuestsOther_6:AddParagraph({
...
if World3 then
local _s_QuestsOther_7 = Tabs.QuestsOther:AddSection("Cursed Dual Katana (CDK)", true)

    local CDKProgress = _s_QuestsOther_7:AddParagraph({
        Title = "CDK Progress",
...
if World3 then
local _s_QuestsOther_8 = Tabs.QuestsOther:AddSection("True Triple Katana", true)

    _s_QuestsOther_8:AddButton({
...
local _s_SeaEvent_1 = Tabs.SeaEvent:AddSection("Sea Event / Setting Sail", true)
...
_s_SeaEvent_1:AddButton({
    ...
    Callback = function()
        pcall(function()
            ...
            Library:SetNotification({Title = "Lighting", Description = "| Lighting", Content = "Removed fog effects", Time = 0.5, Delay = 3})
        end)
    end
})
        ...
        if _G.SelectedBoat then
            pcall(function()
                ...
                if plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    Library:SetNotification({Title = "Boat Shop", Description = "| Boat Shop", Content = "Purchased: ", Time = 0.5, Delay = 3})
                end
            end)
        else
            Library:SetNotification({Title = "Boat Shop", Description = "| Boat Shop", Content = "Please select a boat first", Time = 0.5, Delay = 3})
        end
    end
})
...
local _s_SeaEvent_2 = Tabs.SeaEvent:AddSection("Select what you will farm", true)

_s_SeaEvent_2:AddToggle({
...
if World2 then
local _s_SeaEvent_3 = Tabs.SeaEvent:AddSection("Go to Sea 3 for more options", true)
end
if World1 then
local _s_SeaEvent_4 = Tabs.SeaEvent:AddSection("Go to Sea 3 or Sea 2 for Farm maritime events", true)
end
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
    _s_SeaEvent_4:AddToggle({
        Title = "Auto Shark",
        Default = false,
        Callback = function(Value)
            _G.Shark = Value
...
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
local _s_SeaEvent_5 = Tabs.SeaEvent:AddSection("Frozen Dimension", true)

    _s_SeaEvent_5:AddButton({
        Title = "Buy Spy",
        Callback = function()
...
local _s_SeaEvent_6 = Tabs.SeaEvent:AddSection("Kitsune Island / Event", true)

    _s_SeaEvent_6:AddToggle({
...
local _s_SeaEvent_7 = Tabs.SeaEvent:AddSection("Skill Selection", true)
...
local _s_VolcanoDojo_1 = Tabs.VolcanoDojo:AddSection("Prehistoric Island", true)

local PrehistoricStatus = _s_VolcanoDojo_1:AddParagraph({
...
local _s_VolcanoDojo_2 = Tabs.VolcanoDojo:AddSection("Skill Selection (Prehistoric)", true)
...
local _s_VolcanoDojo_3 = Tabs.VolcanoDojo:AddSection("Main Prehistoric Options", true)

_s_VolcanoDojo_3:AddToggle({
...
local KillAuraDisplay = _s_VolcanoDojo_3:AddParagraph({
...
local _s_VolcanoDojo_4 = Tabs.VolcanoDojo:AddSection("Volcanic Crafting", true)

_s_VolcanoDojo_4:AddButton({
    ...
    Callback = function()
        pcall(function()
            ...
            Library:SetNotification({Title = "Crafting", Description = "| Crafting", Content = "Attempted to craft Volcanic Magnet", Time = 0.5, Delay = 3})
        end)
    end
})

_G.AutoCraftVolcanic = _G.AutoCraftVolcanic or false
_s_VolcanoDojo_4:AddToggle({
...
local _s_VolcanoDojo_5 = Tabs.VolcanoDojo:AddSection("Drago Trials", true)

_s_VolcanoDojo_5:AddToggle({
...
local _s_VolcanoDojo_6 = Tabs.VolcanoDojo:AddSection("Dojo Quest", true)

_s_VolcanoDojo_6:AddButton({
...
local _s_MirageRace_1 = Tabs.MirageRace:AddSection("Mirage Island / Full Moon", true)

local FullMoonStatus = _s_MirageRace_1:AddParagraph({
    Title = "Full Moon Status",
    Content = "Checking..."
})

local MirageIslandStatus = _s_MirageRace_1:AddParagraph({
...
local _s_MirageRace_2 = Tabs.MirageRace:AddSection("Mirage Island Features", true)

_s_MirageRace_2:AddToggle({
...
local _s_MirageRace_3 = Tabs.MirageRace:AddSection("Advanced Fruit Dealer", true)

_s_MirageRace_3:AddToggle({
...
local _s_MirageRace_4 = Tabs.MirageRace:AddSection("Race V4 / Temple of Time", true)

_s_MirageRace_4:AddButton({
...
_s_MirageRace_4:AddButton({
    ...
    Callback = function()
        pcall(function()
            ...
            Library:SetNotification({Title = "Race V4", Description = "| Race V4", Content = "Talked with Stone", Time = 0.5, Delay = 3})
        end)
    end
})

local TiersStatus = _s_MirageRace_4:AddParagraph({
...
local _s_MirageRace_5 = Tabs.MirageRace:AddSection("Trials Quest V4", true)

_s_MirageRace_5:AddToggle({
...
local _s_MirageRace_6 = Tabs.MirageRace:AddSection("Moon / Race Abilities", true)

_s_MirageRace_6:AddToggle({
...
local _s_MirageRace_7 = Tabs.MirageRace:AddSection("Upgrade Races V2 And V3", true)

_s_MirageRace_7:AddToggle({
...
local _s_FruitsCheck_1 = Tabs.FruitsCheck:AddSection("Fruits Options", true)
...
local StockParagraph = _s_FruitsCheck_1:AddParagraph({
    Title = "Fruit Stock",
    Content = "Loading..."
})
...
_s_FruitsCheck_1:AddButton({
    Title = "Refresh Stock Now",
    Callback = function()
        pcall(function()
            Library:SetNotification({Title = "Fruit Stock", Description = "| Fruit Stock", Content = "Stock refreshed", Time = 0.5, Delay = 2})
        end)
    end
})

local _s_FruitsCheck_2 = Tabs.FruitsCheck:AddSection("Fruit Auto Functions", true)

_s_FruitsCheck_2:AddToggle({
...
local _s_FruitsCheck_3 = Tabs.FruitsCheck:AddSection("Fruit Shop Sniper", true)
...
local _s_FruitsCheck_4 = Tabs.FruitsCheck:AddSection("Fruit Stock Checker", true)
...
local FruitCheckResult = _s_FruitsCheck_4:AddParagraph({
    Title = "Fruit Status",
    Content = "Select a fruit to check"
})

_s_FruitsCheck_4:AddButton({
    ...
    Callback = function()
        ...
        pcall(function()
            ...
            if inStock then
                Library:SetNotification({Title = "Fruit Stock", Description = "| Fruit Stock", Content = "", Time = 0.5, Delay = 5})
            else
            end
        end)
    end
...
local _s_RaidDungoen_1 = Tabs.RaidDungoen:AddSection("Raid Status", true)

local RaidTimerStatus = _s_RaidDungoen_1:AddParagraph({
    Title = "Raid Timer",
    Content = "Not in raid"
})

local RaidIslandStatus = _s_RaidDungoen_1:AddParagraph({
    Title = "Current Island",
    Content = "None"
})

local RaidMobsStatus = _s_RaidDungoen_1:AddParagraph({
...
local _s_RaidDungoen_2 = Tabs.RaidDungoen:AddSection("Chip Selection", true)
...
local _s_RaidDungoen_3 = Tabs.RaidDungoen:AddSection("Buy Chip", true)

_s_RaidDungoen_3:AddButton({
...
local _s_RaidDungoen_4 = Tabs.RaidDungoen:AddSection("Raid Controls", true)

_G.AutoStartRaid = GetSetting("Raid_AutoStartRaid", false)
_s_RaidDungoen_4:AddToggle({
...
local _s_RaidDungoen_5 = Tabs.RaidDungoen:AddSection("Auto Farm Dungeon", true)
...
local _s_RaidDungoen_6 = Tabs.RaidDungoen:AddSection("Teleport Floors", true)

_s_RaidDungoen_6:AddButton({
...
local _s_RaidDungoen_7 = Tabs.RaidDungoen:AddSection("Awakening", true)

_G.AutoAwaken = GetSetting("Raid_AutoAwaken", false)
_s_RaidDungoen_7:AddToggle({
...
local _s_RaidDungoen_8 = Tabs.RaidDungoen:AddSection("Law/Order Raid", true)

_s_RaidDungoen_8:AddButton({
...
local _s_RaidDungoen_9 = Tabs.RaidDungoen:AddSection("Teleport", true)

_G.TpLab = GetSetting("Raid_TpLab", false)
_s_RaidDungoen_9:AddToggle({
...
local _s_RaidDungoen_10 = Tabs.RaidDungoen:AddSection("Kill Aura", true)
...
local KillAuraCounter = 0
local KillAuraDisplay = _s_RaidDungoen_10:AddParagraph({
    Title = "Kill Aura Stats",
    Content = "Killed: 0"
})
...
local _s_TeleportWorld_1 = Tabs.TeleportWorld:AddSection("Travel - Worlds", true)

_s_TeleportWorld_1:AddButton({
...
local _s_TeleportWorld_2 = Tabs.TeleportWorld:AddSection("Travel - Island", true)
...
_s_TeleportWorld_2:AddDropdown({
...
local _s_TeleportWorld_3 = Tabs.TeleportWorld:AddSection("Travel - Portal", true)
...
_s_TeleportWorld_3:AddDropdown({
    Title = "Select Portal",
...
local _s_TeleportWorld_4 = Tabs.TeleportWorld:AddSection("Travel - NPCs", true)
...
_s_TeleportWorld_4:AddDropdown({
    Title = "Select NPCs",
    Options = NPCList,
    Default = false,
    Multi = false,
...
local _s_EspStats_1 = Tabs.EspStats:AddSection("Stats Upgrade", true)

local StatsValue = 10
_s_EspStats_1:AddSlider({
    Title = "Stats Value",
    Min = 0,
    Max = 1000,
...
local _s_EspStats_2 = Tabs.EspStats:AddSection("ESP", true)
...
local _s_Shop_1 = Tabs.Shop:AddSection("Mua Melee V1", true)
        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    Library:SetNotification({Title = "Bear Hub", Description = "| Bear Hub", Content = "Lỗi: Không tìm thấy toạ độ cho Melee này ở Sea hiện tại!", Time = 0.5, Delay = 3})
                ...
                if lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if dist > 15 then
                        ...
                        Library:SetNotification({Title = "Bear Hub", Description = "| Bear Hub", Content = "Đã mua: ", Time = 0.5, Delay = 2})
                        task.wait(1)
                    end
                end
            end
...
local _s_Shop_2 = Tabs.Shop:AddSection("Mua Đồ Craft Sea Event", true)

_s_Shop_2:AddButton({
    Title = "Craft Dragonheart",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "Dragonheart")
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft Dragonheart", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft Dragonstorm", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft DinoHood", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft SharkTooth", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft TerrorJaw", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft SharkAnchor", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft LeviathanCrown", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft LeviathanShield", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft LeviathanBoat", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft LegendaryScroll", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_2:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Craft", Description = "| Craft", Content = "Đã craft MythicalScroll", Time = 0.5, Delay = 2})
    end
})

local _s_Shop_3 = Tabs.Shop:AddSection("Mua Haki, Soru, Geppo", true)

_s_Shop_3:AddButton({
    Title = "Buy Geppo $10,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Geppo")
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Geppo", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_3:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Buso Haki", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_3:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Soru", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_3:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Observation Haki", Time = 0.5, Delay = 2})
    end
})

local _s_Shop_4 = Tabs.Shop:AddSection("Mua Kiếm, Súng", true)

_s_Shop_4:AddButton({
    Title = "Buy Cutlass $1,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cutlass")
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Cutlass", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Katana", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Iron Mace", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Dual Katana", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Triple Katana", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Pipe", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Dual-Headed Blade", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Bisento", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Soul Cane", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Pole V2", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Slingshot", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Musket", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Flintlock", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Refined Slingshot", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock")
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Refined Flintlock", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Cannon", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Kabucha", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Bizarre Rifle", Time = 0.5, Delay = 2})
    end
})

local _s_Shop_5 = Tabs.Shop:AddSection("Mua Phụ Kiện", true)

_s_Shop_5:AddButton({
    Title = "Buy Black Cape $50,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Black Cape")
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Black Cape", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_5:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Swordsman Hat", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_5:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Shop", Description = "| Shop", Content = "Đã mua Tomoe Ring", Time = 0.5, Delay = 2})
    end
})

local _s_Shop_6 = Tabs.Shop:AddSection("Đổi Tộc, Reset Stats", true)

_s_Shop_6:AddButton({
    Title = "Đổi Tộc Ghoul",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm", "Change", 4)
        Library:SetNotification({Title = "Race", Description = "| Race", Content = "Đã đổi sang Ghoul", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_6:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Race", Description = "| Race", Content = "Đã đổi sang Cyborg", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_6:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Stats", Description = "| Stats", Content = "Đã Reset Stats", Time = 0.5, Delay = 2})
    end
})
...
_s_Shop_6:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Race", Description = "| Race", Content = "Đã Random Race", Time = 0.5, Delay = 2})
    end
})

local _s_Settings_1 = Tabs.Settings:AddSection("Server Functions", true)

_s_Settings_1:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            Library:SetNotification({Title = "Error", Description = "| Error", Content = "Không tìm thấy remote Redeem", Time = 0.5, Delay = 3})
            return
        end
        ...
        Library:SetNotification({Title = "Success", Description = "| Success", Content = "Đã thử nhập tất cả mã", Time = 0.5, Delay = 3})
    end
})

local _s_Settings_2 = Tabs.Settings:AddSection("Player GUI / Others", true)

_s_Settings_2:AddButton({
...
local _s_Settings_3 = Tabs.Settings:AddSection("Graphics / Haki Stats", true)

local HakiStages = {"Stage 0", "Stage 1", "Stage 2", "Stage 3", "Stage 4", "Stage 5"}
_s_Settings_3:AddDropdown({
...
local _s_Settings_4 = Tabs.Settings:AddSection("Misc Graphics", true)

_s_Settings_4:AddToggle({
...
_s_Settings_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Graphics", Description = "| Graphics", Content = "Đã chuyển sang chế độ Fast Mode", Time = 0.5, Delay = 2})
    end
})
...
_s_Settings_4:AddButton({
    ...
    Callback = function()
        LowCpu()
        Library:SetNotification({Title = "Optimization", Description = "| Optimization", Content = "Đã bật chế độ Low CPU", Time = 0.5, Delay = 2})
    end
})
...
_s_Settings_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Boats", Description = "| Boats", Content = "Đã tăng tốc độ thuyền (phía client)", Time = 0.5, Delay = 2})
    end
})
...
_s_Settings_4:AddButton({
    ...
    Callback = function()
        ...
        Library:SetNotification({Title = "Fog", Description = "| Fog", Content = "Đã xóa sương mù", Time = 0.5, Delay = 2})
    end
})

local _s_Settings_5 = Tabs.Settings:AddSection("Configure - God", true)

_s_Settings_5:AddButton({
...
local _s_PvPPlayer_1 = Tabs.PvPPlayer:AddSection("Pvp, Aimbot, Movement", true)
...
local PlayerDropdown = _s_PvPPlayer_1:AddDropdown({
...
local _s_PvPPlayer_2 = Tabs.PvPPlayer:AddSection("Aimbot", true)

_s_PvPPlayer_2:AddToggle({
...
local _s_PvPPlayer_3 = Tabs.PvPPlayer:AddSection("Speed/Jump", true)
...
local _s_PvPPlayer_4 = Tabs.PvPPlayer:AddSection("LocalPlayer Settings / Misc", true)

_s_PvPPlayer_4:AddToggle({
...
local _s_PvPPlayer_5 = Tabs.PvPPlayer:AddSection("Settings Combat / Aimbot Settings", true)

_s_PvPPlayer_5:AddToggle({
